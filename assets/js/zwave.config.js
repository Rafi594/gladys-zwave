var translationsEN = {
    ...
    CONFIGURATION_CONTROLLER_TEXT: 'Select your controller from the list to save information such as manufacturer and device type. As well as the com port change to next restart, the controller will automatically be called to this information and its com port will be updated.',
    CONFIGURATION: 'Configuration',    
    CONFIGURATION_CONTROLLER: 'Configuration\'s controller',
    EMPTY_NODE_TABLE: 'There is no node. To add, click network management and then include a node. Or configure controller\'s port for start it.',
...
var translationsFR = {
    ...
    EMPTY_NODE_TABLE: 'Il n\'y a aucun noeud. Pour en ajouter cliquez sur gestion du réseau puis sur inclure un noeud. Ou configurez le port du controller pour le demarer.',
